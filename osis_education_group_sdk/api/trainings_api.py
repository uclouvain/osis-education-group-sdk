...
class TrainingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.training_prerequisites_official_endpoint = _Endpoint(
            settings={
        ...
        self.training_version_endpoint = _Endpoint(
            settings={
        ...
        self.trainings_credits_read_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2001,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/trainings/{year}/{acronym}/credits',
                'operation_id': 'trainings_credits_read',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.trainings_list_endpoint = _Endpoint(
            settings={
        ...
        self.trainings_offer_roots_endpoint = _Endpoint(
            settings={
                'response_type': (PaginatedTraining,),
                'auth': [
                    'Token'
        ...
        self.trainings_read_endpoint = _Endpoint(
            settings={
                'response_type': (TrainingDetailed,),
                'auth': [
                    'Token'
        ...
        self.trainings_tree_endpoint = _Endpoint(
            settings={
                'response_type': (Tree,),
                'auth': [
                    'Token'
        ...
        self.trainingstitle_read_endpoint = _Endpoint(
            settings={
        ...
        self.trainingsversiontitle_read_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse200,),
                'auth': [
                    'Token'
        ...
        self.versions_tree_endpoint = _Endpoint(
            settings={
                'response_type': (Tree,),
                'auth': [
                    'Token'
    ...
    def training_prerequisites_official(
        self,
        year,
        acronym,
        **kwargs
        ...
        kwargs['acronym'] = \
            acronym
        return self.training_prerequisites_official_endpoint.call_with_http_info(**kwargs)
    ...
    def training_version(
        ...
        **kwargs
        ...
        kwargs['version_name'] = \
            version_name
        return self.training_version_endpoint.call_with_http_info(**kwargs)

    def trainings_credits_read(
        self,
        year,
        acronym,
        **kwargs
    ):
        """trainings_credits_read  # noqa: E501

        Return the credits of the training  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.trainings_credits_read(year, acronym, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['acronym'] = \
            acronym
        return self.trainings_credits_read_endpoint.call_with_http_info(**kwargs)
    ...
    def trainings_list(
        ...
        **kwargs
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.trainings_list_endpoint.call_with_http_info(**kwargs)

    def trainings_offer_roots(
        self,
        year,
        acronym,
        **kwargs
        ...
        kwargs['acronym'] = \
            acronym
        return self.trainings_offer_roots_endpoint.call_with_http_info(**kwargs)
    ...
    def trainings_read(
        ...
        **kwargs
        ...
        kwargs['acronym'] = \
            acronym
        return self.trainings_read_endpoint.call_with_http_info(**kwargs)
    ...
    def trainings_tree(
        ...
        **kwargs
        ...
        kwargs['acronym'] = \
            acronym
        return self.trainings_tree_endpoint.call_with_http_info(**kwargs)

    def trainingstitle_read(
        self,
        year,
        acronym,
        **kwargs
        ...
        kwargs['acronym'] = \
            acronym
        return self.trainingstitle_read_endpoint.call_with_http_info(**kwargs)

    def trainingsversiontitle_read(
        self,
        year,
        acronym,
        version_name,
        **kwargs
        ...
        kwargs['version_name'] = \
            version_name
        return self.trainingsversiontitle_read_endpoint.call_with_http_info(**kwargs)
    ...
    def versions_tree(
        ...
        **kwargs
        ...
        kwargs['version_name'] = \
            version_name
        return self.versions_tree_endpoint.call_with_http_info(**kwargs)
