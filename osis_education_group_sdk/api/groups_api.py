...
class GroupsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.groups_tree = _Endpoint(
            ...
            api_client=api_client,
            callable=__groups_tree
        )

        def __groupstitle_read(
            self,
            year,
            partial_acronym,
            **kwargs
        ...
        self.groupstitle_read = _Endpoint(
            settings={
