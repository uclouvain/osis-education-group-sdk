...
class HabilitationListApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.habilitations_list_endpoint = _Endpoint(
            settings={
                'response_type': (Hops,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/hops/{year}',
                'operation_id': 'habilitations_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def habilitations_list(
        self,
        year,
        **kwargs
    ):
        """habilitations_list  # noqa: E501

        Return the list of used habilitations for a given year.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.habilitations_list(year, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['year'] = \
            year
        return self.habilitations_list_endpoint.call_with_http_info(**kwargs)
