...
class Node(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, code, title, node_type, subtype, is_mandatory, block, access_condition, comment, remark, remark_en, link_type, link_type_text, children, *args, **kwargs):  # noqa: E501
