...
class ArrayOfProgramTreePrerequisites(ModelSimple):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': ([ProgramTreePrerequisites],),
        }
    ...
    def __init__(self, *args, **kwargs):
        """ArrayOfProgramTreePrerequisites - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ProgramTreePrerequisites]):  # noqa: E501

        Keyword Args:
            value ([ProgramTreePrerequisites]):  # noqa: E501
