...
class AcademicTypeEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AcademicTypeEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["NON_ACADEMIC", "NON_ACADEMIC_CREF", "ACADEMIC", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["NON_ACADEMIC", "NON_ACADEMIC_CREF", "ACADEMIC", ]  # noqa: E501
