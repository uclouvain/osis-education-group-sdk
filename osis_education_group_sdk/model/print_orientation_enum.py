...
class PrintOrientationEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PrintOrientationEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["NO_PRINT", "IN_HEADING_2_OF_DIPLOMA", "IN_EXPECTED_FORM", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["NO_PRINT", "IN_HEADING_2_OF_DIPLOMA", "IN_EXPECTED_FORM", ]  # noqa: E501
