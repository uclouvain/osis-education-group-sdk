...
class GroupTypeEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["COMMON_CORE", "MINOR_LIST_CHOICE", "MAJOR_LIST_CHOICE", "OPTION_LIST_CHOICE", "FINALITY_120_LIST_CHOICE", "FINALITY_180_LIST_CHOICE", "MOBILITY_PARTNERSHIP_LIST_CHOICE", "COMPLEMENTARY_MODULE", "SUB_GROUP", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["COMMON_CORE", "MINOR_LIST_CHOICE", "MAJOR_LIST_CHOICE", "OPTION_LIST_CHOICE", "FINALITY_120_LIST_CHOICE", "FINALITY_180_LIST_CHOICE", "MOBILITY_PARTNERSHIP_LIST_CHOICE", "COMPLEMENTARY_MODULE", "SUB_GROUP", ]  # noqa: E501
