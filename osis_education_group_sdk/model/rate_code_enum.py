...
class RateCodeEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """RateCodeEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["NO_ADDITIONAL_FEES", "AESS_CAPAES", "MINERVAL_COMPLETE", "UNIVERSITY_CERTIFICATE", "ADVANCED_MASTER_IN_MEDICAL_SPECIALIZATION", "ACCESS_CONTEST", "UNIVERSITY_CERTIFICATE_30_CREDITS", "CERTIFICATE_MEDECINE_COMPETENCE", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["NO_ADDITIONAL_FEES", "AESS_CAPAES", "MINERVAL_COMPLETE", "UNIVERSITY_CERTIFICATE", "ADVANCED_MASTER_IN_MEDICAL_SPECIALIZATION", "ACCESS_CONTEST", "UNIVERSITY_CERTIFICATE_30_CREDITS", "CERTIFICATE_MEDECINE_COMPETENCE", ]  # noqa: E501
